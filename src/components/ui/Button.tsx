...
export const buttonVariants = cva(
  ...
  variants: {
    variant: {
      ...
      // link: 'bg-transparent dark:bg-transparent underline-offset-4  hover:underline text-slate-900 dark:text-slate-100 hover:bg-transparent hover:dark:bg-transparent',
